...
- **Memory metadata** — strength, access count, last accessed, source tracking; access history protects memories from decay, content freshness breaks ranking near-ties
