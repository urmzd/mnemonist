...
A specification and Rust implementation defining a convention for storing AI agent memory as plain markdown files. Two levels: project (`.ai-memory/` at repo root) and global (`~/.config/ai-memory/`).
